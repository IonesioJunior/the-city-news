"""Command line interface for The City News fetcher."""
...
@click.option(
    '--url', 
    default="https://www.thecity.nyc/feed/",
...
@click.option(
    '--user-agent', 
    default="The City News Fetcher 1.0",
...
def main(url: str, output_dir: Path, max_articles: int, no_content: bool, 
    ...
    """Fetch news articles from The City NYC RSS feed and save as markdown files."""
    
    console.print(f"[bold blue]The City News Fetcher[/bold blue]")
